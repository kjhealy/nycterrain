...
Use `nyc_terrain_path()` to get the GeoTIFF path directly, e.g. for use
with `stars`, GDAL, or `rayshader`:
...
<img src="man/figures/README-terrain-map-1.png" alt="" width="100%" />
...
<img src="man/figures/README-hillshade-1.png" alt="" width="100%" />
